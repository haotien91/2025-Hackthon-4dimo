...
function SearchPageInner() {
  ...
  const FIRST_MIN_SPIN_MS = 2000; // 首次載入至少轉 2 秒
  const NEXT_MIN_SPIN_MS  = 600;  // 無限捲動每頁至少轉 0.6 秒（可視覺感受調整）
